...
//设置加载管理器
const loadingManagment = new THREE.LoadingManager(
    event.onLoad,event.onProgress,event.onError
)


// 导入纹理
const textureLoader = new THREE.TextureLoader(loadingManagment)
const doorColorTexture = textureLoader.load('./texture/11d7e63e_E735249_37b7eda8.jpg',event.onLoad,event.onProgress,event.onError)
